...
func get_tile_at_pos(pos: Vector2) -> Tile:
...
func modify_matrix_tile_at_pos(pos: Vector2, tile: Tile) -> void:
	grid_matrix[pos.y/TILE_SIZE][pos.x/TILE_SIZE][0] = tile
	
func modify_matrix_piece_at_pos(pos: Vector2, piece: Piece) -> void:
